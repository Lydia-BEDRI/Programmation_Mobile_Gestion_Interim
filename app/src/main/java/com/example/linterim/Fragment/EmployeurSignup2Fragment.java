...
public class EmployeurSignup2Fragment extends Fragment {
    ...
    private TextView textViewLienLKIN;
            ...
            public void onClick(View v) {
                ...
                if (args != null) {
                    ...
                    if (!TextUtils.isEmpty(AdresseEntreprise) && !TextUtils.isEmpty(NumTel) &&
                            !TextUtils.isEmpty(LienLKIN)){
                        registerEmployeFacultativeInfos(nomEntreprise,adresseMail,motDePasse,AdresseEntreprise,NumTel,LienLKIN);

                    }else{
                        registerEmploye(nomEntreprise,adresseMail,motDePasse);
    ...
    private void registerEmploye(String nomEntreprise, String adresseMail, String motDePasse) {
    ...
    private void registerEmployeFacultativeInfos(String nomEntreprise, String adresseMail, String motDePasse, String adresseEntreprise, String numTel, String lienLKIN) {
    }
}
